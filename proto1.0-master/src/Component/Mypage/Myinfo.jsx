...
const Myinfo = () => {
    ...
    return(
        ...
        <div className="myinfo-container">
            ...
            <div id="myinfo-adrres-code">활동 지역</div>
            <div id="myinfoac">
                {location}
            </div>

            <div id="myinfo-total-quantity">총구매수량</div>
            <div id="myinfotq">
                {userInfo?.totalBuyCount}
            </div>

            <div id="myinfo-total-price">총구매금액</div>
            <div id="mytp">
                {userInfo?.totalBuyCost}원
            </div>
